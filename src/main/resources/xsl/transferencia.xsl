...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:env="http://schemas.xmlsoap.org/soap/envelope/" xmlns:men="http://www.bolivariano.com/CashManagement/MensajeTransferencias"
	exclude-result-prefixes="xsl">
	<xsl:output omit-xml-declaration="yes"/>
	<xsl:template match="/">
<men:mensajeSalidaEjecutarTransferencia>
